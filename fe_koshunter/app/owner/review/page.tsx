    ...
    return (
        <div className="bg-white rounded-xl p-5 border-t-4 border-t-primary shadow-md">
            ...
            <div className="flex justify-end mb-4">
                {/* <AddReview onSuccess={() => fetchReviews()} kosId={kosId} /> */}
            </div>
                        ...
                        <tbody>
                            {reviews.map((review) => (
                                ...
                                >
                                    ...
                                    <td className="p-3">
                                        <span className={`px-3 py-1 text-xs rounded-full ${ROLE_STYLE[review.user.role.toLowerCase()] || "bg-gray-100 text-gray-600"}`}>
                                            {review.user.role}
                                        </span>
                                    </td>
