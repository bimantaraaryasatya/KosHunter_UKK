...
app.get("/", authenticateToken, authorizeRoles('society', 'owner', 'admin'), userController.getAllUser)
app.post("/find", authenticateToken, authorizeRoles('society', 'owner', 'admin'), userController.findUser)
